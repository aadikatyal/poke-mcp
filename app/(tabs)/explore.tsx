  ...
  const leaderboardData = useMemo(() => ([
    {
      ...
      picks: [
        ...
        { player: 'James Cook', stat: 'Rush+Rec TDs', direction: 'up', line: '0.5', result: 'pending' },
      ],
    },
    {
      username: 'Satvik',
    ...
    },
    {
      ...
      picks: [
        ...
        { player: 'Shohei Ohtani', stat: 'Total Bases', direction: 'up', line: '2.0', result: 'hit' },
        { player: 'Giannis Antetokounmpo', stat: 'Points', direction: 'down', line: '28.5', result: 'pending' },
      ],
    },
    {
      username: 'Harish',
